...
import { KOOMU_CONSTANTS } from "@/constants"
...
const CreateGroupLayout = ({ children }: Props) => {
  console.log("Stripe Public Key:", process.env.NEXT_PUBLIC_STRIPE_PUBLISH_KEY)
    ...
    <div className="container h-screen grid grid-cols-1 lg:grid-cols-2 content-center">
      <div className="flex items-center">
        <BackdropGradient className="w-8/12 h-2/6 opacity-50">
          <h5 className="text-2xl font-bold text-themeTextWhite">Koomu.</h5>
          ...
          <div className="flex flex-col gap-3 mt-16 pl-5">
            {KOOMU_CONSTANTS.createGroupPlaceholder.map((placeholder) => (
